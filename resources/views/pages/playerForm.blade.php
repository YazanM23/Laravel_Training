...
<div class="hero overlay" style="background-image: url('../resources/images/bg_3.jpg');">
    ...
    <div class="container">
<section class="ftco-section" style="padding-top: 20%; ">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    ...
                    <form action="{{route('pages.signupPlayer')}}" class="signin-form" method="post">
                        @csrf
                        ...
                        <div class="form-group" style="display: flex; ">
                            ...
                            <input type="number" class="form-control" placeholder="Weight" name="weight" required style="margin-left: 3%">
                        </div>
                        <div class="form-group">
                            <select id="listPicker" onchange="displaySelectedOption()" class="form-control" name="team">
                                ...
                                <option value="Real Madrid" name="realmadrid">Real Madrid</option>
                            </select>
